...
2. [Tunnel ETH to Hemi](../../using-hemi/tunnel-from-ethereum/tunnel-eth-to-hemi.md)
...
{% hint style="warning" %}
The address you choose to connect **MUST** have some ETH (recommended at least 0.01 ETH) to pay for contract deployment fees. Refer back to earlier documentation to [fund your Hemi address](../../using-hemi/tunnel-from-ethereum/tunnel-eth-to-hemi.md) with ETH.
{% endhint %}
